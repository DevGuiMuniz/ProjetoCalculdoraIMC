...
public class activity_obesidade2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMensagem.setText("Sua saúde merece atenção! Você consegue melhorar com apoio e determinação.");
